...
//console.log(config);
const myTwitterStrategy = Snbot.TwitterStrategy.default

// Use the TwitterStrategy within Passport.
passport.use( myTwitterStrategy );
...
app.get('/auth/twitter/callback', (req, res, next) => {
  ...
  return passport.authenticate('twitter', { failureRedirect: req.session.returnTo })(req, res, next)
}, function(req, res) {
...
app.get('/logout', function (req, res) {
  req.session.destroy(() => {
    console.log('session destroyed: Redirect back');
    res.redirect('back');
  })
});
