import { Operand, operator, operation, calculate, Equation, ref } from '../equation'
import * as filter from '../filter'
import * as asnbot from '../abot'
...
describe(' #FindOperation ', async function () {
    it('find', () => {
        ...
        let res = operation['find']('Kelly','name',database)
        console.log('res :', res)

        let e = new Equation([new Operand(database), new Operand('name'), new Operand('Kelly'), operator('find')])
